		...
		<div class="container">
			<div class="wrapper employee_list clearfix">
				...
				<div class="top-bar">
                    ...
                    <div class="top-item">
                        <form id="empFilter" method="post" action="">
                            <select class="departmentFilter" onchange="currsearchFilter()">
				...
				<?php
					$getemp = mysqli_query($db_connect, "SELECT s.*, d.name FROM sharp_emp s inner join departments d on d.id = s.department_id WHERE status = 'employee' ORDER BY id ASC");
