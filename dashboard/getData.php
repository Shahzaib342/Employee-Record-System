<?php
    ...
    if($action == "allemployee"){
        ...
        if(!empty($keywords) && $department > 0){
            $whereSQL = "WHERE (first_name LIKE '%".$keywords."%' OR last_name LIKE '%".$keywords."%' OR middle_name LIKE '%".$keywords."%') AND (department_id = $department)";
        }
        elseif($department > 0){
            $whereSQL .= "WHERE department_id = $department";
        }
        ...
        //get rows
        $queryNum = mysqli_query($db_connect, "SELECT s.*, d.name as department FROM sharp_emp s inner join departments d on d.id = s.department_id  $whereSQL $orderSQL LIMIT $start, $limit");
                                        ...
                                        if($usertype == "Admin"){
                                            echo '                                      
                                                <li class="emp_item">
                                                    ...
                                                    <div class="emp_column">'.$department.'</div>
    ...
    if($action == "currentemployees"){
        ...
        $department = isset($_POST['department']) ? $_POST['department'] : 0;
        if(!empty($keywords) && $department > 0){
            $whereSQL = "WHERE (`middle_name` LIKE '%".$keywords."%' OR `last_name` LIKE '%".$keywords."%' OR `first_name` LIKE '%".$keywords."%') AND (`status` = 'employee') AND (department_id = $department)";
        }
        elseif (!empty($keywords)) {
            $whereSQL = "WHERE (`middle_name` LIKE '%".$keywords."%' OR `last_name` LIKE '%".$keywords."%' OR `first_name` LIKE '%".$keywords."%') AND `status` = 'employee'";
        }
        elseif($department > 0) {
            $whereSQL = "WHERE department_id = $department AND `status` = 'employee'";
        } else {
    ...
    if($action == "pastemployees"){
        ...
        $department = isset($_POST['department']) ? $_POST['department'] : 0;
        if(!empty($keywords) && $department > 0){
            $whereSQL = "WHERE (`middle_name` LIKE '%".$keywords."%' OR `last_name` LIKE '%".$keywords."%' OR `first_name` LIKE '%".$keywords."%') AND (`status` = 'former') AND (department_id = $department)";
        }
        elseif(!empty($keywords)){
            $whereSQL = "WHERE (`middle_name` LIKE '%".$keywords."%' OR `last_name` LIKE '%".$keywords."%' OR `first_name` LIKE '%".$keywords."%') AND `status` = 'former'";
        }
        elseif($department > 0) {
            $whereSQL = "WHERE department_id = $department AND `status` = 'former'";
        }
        else {
