		...
		<div class="container">
			<div class="wrapper employee_list clearfix">
				...
				<div class="top-bar">
                    ...
                    <div class="top-item">
                        <form id="empFilter" method="post" action="">
                            <select class="departmentFilter" onchange="searchFilter()">
				...
				<?php
					$getemp = mysqli_query($db_connect, "SELECT sharp_emp.*, d.name FROM sharp_emp inner join departments d on d.id = sharp_emp.department_id ORDER BY employee_id ASC LIMIT $limit");
				...
				<ul class="emp_list">
					<li class="emp_list_head">
                        ...
                        <div class="emp_item_head">Department</div>
										...
										if($usertype == "Admin"){
											echo '										
												<li class="emp_item">
													...
													<div class="emp_column emp_name">'.$first_name. " " . $first_name . " " .$last_name.'</div>
