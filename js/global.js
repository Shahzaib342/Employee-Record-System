$(document).ready(function(){
    ...
    */
    $("#addemployee").submit(function(e){
		...
		if($(".emp_id").val() == ""){
			empiderror = "Please enter employee's id";
		} else {
			empiderror = "";
		}
    	...
    	$(".empiderror").html(empiderror);


    	if(empiderror == "" && firstnameerror == "" && lastnameerror == "" && dateemployederror == "" && empstatuserror == "") {
    		...
    		console.log("The form is not allowed to submit");
		}
    ...
    */
    $("#editemployee").submit(function(e){
    	...
    	if(firstnameerror == "" && empiderror == "" && lastnameerror == "" && dateemployederror == "" && fullnameerror == "" && empstatuserror == "") {
